...
channel_conversation_second = BenchConversation.create!(conversationable_type: 'BenchChannel', conversationable_id: channel_second.id, topic: "developers")
channel_conversation_third = BenchConversation.create!(conversationable_type: 'BenchChannel', conversationable_id: channel_third.id, topic: "bench-it")
...
profile_conversation_first = BenchConversation.create!(conversationable_type: 'Profile', conversationable_id: arthur.id, sender_id: alva.id, topic: "arthur-alva")
