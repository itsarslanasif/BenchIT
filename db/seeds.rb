...
user1.profiles.create!(username: 'Alva', description: 'ASE', workspace_id: 1, display_name: 'alva', phone: '1234567890', skype: '1234567890',
                       text_status: 'Laughing', time_zone: 'Karachi', emoji_status: '😂', role: :primary_owner)
...
user1.profiles.create!(username: 'Alvi', description: 'ASE', workspace_id: 2, display_name: 'alvi', phone: '1234567890', skype: '1234567890',
                       text_status: 'Not working', time_zone: 'Karachi', emoji_status: '🤡', role: :primary_owner)
...
DirectMessageUser.create!(profile_id: 1, receiver_id: 1)
DirectMessageUser.create!(profile_id: 2, receiver_id: 2)
DirectMessageUser.create!(profile_id: 3, receiver_id: 3)
DirectMessageUser.create!(profile_id: 4, receiver_id: 4)
