...
ConversationMessage.create(content: "{\"blocks\":[{\"type\":\"section\",\"text\":{\"type\":\"mrkdwn\",\"text\":\"Hi Dev Channel from Alva\"}}]}", is_threaded: false, bench_conversation_id: 1, sender_id: 1)
ConversationMessage.create(content: "{\"blocks\":[{\"type\":\"section\",\"text\":{\"type\":\"mrkdwn\",\"text\":\"Hi Dev Channel from Arnold\"}}]}", is_threaded: false, bench_conversation_id: 1, sender_id: 2)
...
ConversationMessage.create(content: "{\"blocks\":[{\"type\":\"section\",\"text\":{\"type\":\"mrkdwn\",\"text\":\"Hi group from Alva\"}}]}", is_threaded: false, bench_conversation_id: 2, sender_id: 1)
ConversationMessage.create(content: "{\"blocks\":[{\"type\":\"section\",\"text\":{\"type\":\"mrkdwn\",\"text\":\"Hi group from Arnold\"}}]}", is_threaded: false, bench_conversation_id: 2, sender_id: 2)
ConversationMessage.create(content: "{\"blocks\":[{\"type\":\"section\",\"text\":{\"type\":\"mrkdwn\",\"text\":\"Hi group from Arthur\"}}]}", is_threaded: false, bench_conversation_id: 2, sender_id: 3)
BenchConversation.create(conversationable_type: 'Profile', conversationable_id: 1, sender_id: 4)
ConversationMessage.create(content: "{\"blocks\":[{\"type\":\"section\",\"text\":{\"type\":\"mrkdwn\",\"text\":\"Hi User from Austin\"}}]}", is_threaded: false, bench_conversation_id: 3, sender_id: 4)
ConversationMessage.create(content: "{\"blocks\":[{\"type\":\"section\",\"text\":{\"type\":\"mrkdwn\",\"text\":\"Hi User from Alva\"}}]}", is_threaded: false, bench_conversation_id: 3, sender_id: 1)
...
ConversationMessage.create(content: "{\"blocks\":[{\"type\":\"section\",\"text\":{\"type\":\"mrkdwn\",\"text\":\"Hi from watercooler\"}}]}", is_threaded: false, bench_conversation_id: 4, sender_id: 1)
...
ConversationMessage.create(content: "{\"blocks\":[{\"type\":\"section\",\"text\":{\"type\":\"mrkdwn\",\"text\":\"Hi from general\"}}]}", is_threaded: false, bench_conversation_id: 5, sender_id: 2)
...
ConversationMessage.create(content: "{\"blocks\":[{\"type\":\"section\",\"text\":{\"type\":\"mrkdwn\",\"text\":\"1st reply\"}}]}", is_threaded: false, bench_conversation_id: 1, sender_id: 1, parent_message_id: 1)
...
ConversationMessage.create(content: "{\"blocks\":[{\"type\":\"section\",\"text\":{\"type\":\"mrkdwn\",\"text\":\"Hi from developer\"}}]}", is_threaded: false, bench_conversation_id: 6, sender_id: 1)
...
ConversationMessage.create(content: "{\"blocks\":[{\"type\":\"section\",\"text\":{\"type\":\"mrkdwn\",\"text\":\"Hi gropup from Alvi\"}}]}", is_threaded: false, bench_conversation_id: 7, sender_id: 6)
