...
admin.profiles.create!(username: 'Brook Didas', description: 'Admin of workspace', workspace_id: workspace.id)
user1 = User.new(name: 'Rachel', email: 'rachel@gmail.com', password: 'Password1!', jti: SecureRandom.uuid)
user1.save!
user1.profiles.create!(username: 'Rachel Kavari', description: 'ASE', workspace_id: workspace.id)
user2 = User.new(name: 'Durk', email: 'durk@gmail.com', password: 'Password1!', jti: SecureRandom.uuid)
user2.save!
user2.profiles.create!(username: 'Durk', description: 'ASQE', workspace_id: workspace.id)
user3 = User.new(name: 'Arthur', email: 'arthur@gmail.com', password: 'Password1!', jti: SecureRandom.uuid)
user3.save!
user3.profiles.create!(username: 'Arthur Ibrag', description: 'SE', workspace_id: workspace.id)
user = User.new(name: 'Austin', email: 'austin@gmail.com', password: 'Password1!', jti: SecureRandom.uuid)
user.save!
user.profiles.create!(username: 'Hannah Elise', description: 'SSE', workspace_id: workspace.id)
