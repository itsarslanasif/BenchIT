class Api::V1::DirectMessageUsersController < Api::ApiController
  ...
  def set_direct_message_list
    ...
    return render partial: 'api/v1/shared/partials/profiles', locals: { profile: current_profile } if conversation_ids.empty?

    bench_conversations_ids = ConversationMessage.recent_conversation_ids(conversation_ids)
    return render partial: 'api/v1/shared/partials/profiles', locals: { profile: current_profile }  if bench_conversations_ids.empty?
