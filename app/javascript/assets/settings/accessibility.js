export const accessibility = {
  zoom: {
    title: 'Zoom',
    tagline: 'You can also change the zoom level by pressing Ctrl +/-',
    settings: [
      {
        label: '70%',
      },
  ...
  screenReader: {
    title: 'Screen reader',
    tagline: 'Customize your screen reader experience',
  },
  messageFormat: {
    title: 'Message format',
    settings: [
      {
        label: 'Sender, message, and then date and time',
      },
      {
        label: 'Sender, date and time, and then message',
      },
    ],
  },
  directMessageAnnouncement: {
    ...
    settings: [
      {
        label: 'Announce incoming direct messages',
      },
    ],
  },
  huddleAnnouncement: {
    ...
    settings: [
      ...
      {
        label: 'Play a sound when an emoji is sent or received',
      },
    ],
  },
  keyboard: {
    title: 'Keyboard',
    tagline: 'You can improve the way you use Slack by learning our',
    handyKeyboard: 'handy keyboard shortcuts.',
    press: 'Press "." in the empty message field to:',
