<template>
  <div class="flex items-center justify-center flex-col p-2">
    <div class="flex w-1/2">
      ...
      <div v-if="searchModalToggle" class="w-1/6 text-center text-white" @click="searchModalToggle = false">
        <span class="inline-block align-middle">Close</span>
      </div>
      <div v-if="searchModalToggle" class="w-1/2 bg-primaryHover tex
          ``t-center rounded-b absolute z-10 mt-8 shadow-2xl text-white">
        <div class="text-left p-6">
          <p class="mb-1 text-xs">I'm looking for:</p>
          <div class="flex gap-2">
            <button class="bg-slate-500 px-3 py-1 w-auto" @click="searchPeopleOnly">
              People
            </button>
            <button class="bg-slate-500 px-3 py-1 w-auto" @click="searchChannelsOnly">
              Channels
            </button>
          </div>
          <div class="mt-6">
