<template>
  <div class="max-w-lg text-white border-solid border border-slate-200 w-auto h-auto bg-slate-1000">
    <div class="px-5 border-solid border border-slate-200 justify-items-start flex items-center">
      <p class="text-base font-bold text-white">{{ $t('profile.title') }}</p>
      <p class="font-bold ml-auto flex text-white cursor-pointer" @click="exitClicked">
        {{ $t('actions.close') }}
      </p>
    </div>
    <div class="card min-w-sm text-gray-50 transition-shadow shadow-xl hover:shadow-xl min-w-max">
      <div class="w-full card__media flex flex-col-reverse content-end justify-center items-center">
        <img src="https://i.pinimg.com/736x/55/0f/49/550f49a459548599a5a4ea1c67fc0244.jpg"
      ...
      <div class="mt-5 justify-items-start flex items-center">
        <div class="h-2 w-2 border-white border border-solid rounded-md bg-green-700 items-center"></div>
      ...
      <div class="justify-items-start mt-3 flex items-center">
        <button class="button hover:bg-slate-800 border-slate-200 border border-solid mr-1">
          &#x2709; {{ $t('actions.message') }}
        </button>
        <button class="button hover:bg-slate-800 border-slate-200 border border-solid mr-1">
          &#x1F3A7; {{ $t('actions.huddle') }}
      ...
      <div class="font-bold mt-2">{{ $t('profile.contact_information') }}</div>
      <div class="mt-5 hover-trigger justify-items-start flex items-center">
        <div class="bg-gray-600 rounded h-8 w-8 flex flex-col-reverse mr-5 content-end justify-center items-center">
          &#x2709;
        </div>
      ...
      <div class="mt-5 hover-trigger justify-items-start flex items-center">
        ...
        <div @click="copyPhoneNo"
          class="bg-gray-600 rounded h-8 w-8 flex flex-col-reverse hover-target ml-auto content-end justify-center items-center">
          &#x2398;
        </div>
      </div>
    </div>
