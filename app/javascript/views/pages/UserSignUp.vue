  ...
  <div class="h-full w-full bg-white flex flex-col items-center">
    <div class="grid grid-cols-4 items-center w-full p-3">
      ...
      <div class="right-col text-md">
        <p>{{ $t('pages.sign_up.instructions1') }}<br>
          <a class="text-woot-800" href="http://127.0.0.1:5100/sign_in">{{ $t('pages.sign_up.sign_in_instead')}}</a></p>
      </div>
    </div>
    <div class="">
      <div class="flex justify-center items-center h-full bg-gray-100">
        <div class="w-full max-w-md bg-white p-6 rounded-lg shadow-md">
          <h1 class="text-3xl font-bold text-center text-gray-900 mb-4">{{ $t('pages.sign_up.join') }}</h1>
          <h2 class="text-lg text-center text-gray-700 mb-8">{{ $t('pages.sign_up.instructions2')}}</h2>
          <form class="mb-4" @submit.prevent="handleSubmit">
            ...
            <div class="mb-6">
              <label class="flex items-center">
                <input v-model="termsAccepted" class="mr-2 leading-tight" type="checkbox" required>
