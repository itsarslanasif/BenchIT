<template>
  ...
  <div class="flex flex-col overflow-auto paneBody">
    <div class="flex items-center justify-center mt-2">
      <img
        :src="userProfileStore.user_profile?.avatar"
        alt="user avatar"
    ...
    <div class="flex flex-col mt-2">
      <span class="grid grid-cols-12 mx-4">
        <p class="col-span-11 font-bold text-xl break-words">
          {{ userProfileStore.user_profile?.display_name }}
        </p>
        <p
          v-if="ownProfile"
      ...
      <p
        v-if="userProfileStore.user_profile?.title"
        class="float-left text-md mx-4 break-words text-black-800 hover:underline cursor-pointer"
      >
        {{ userProfileStore.user_profile?.title }}
      </p>
      <span
      ...
      <span class="flex float-left mx-4 text-md break-words text-black-800">
        ...
        <p class="float-left text-md break-words text-black-800">
          {{ userProfileStore.user_profile?.localtime }}
    ...
    >
      ...
      >
        ...
        <span class="col-span-2 float-left text-lg text-black-800">
          ...
          >
            {{ userProfileStore.user_profile?.contact_info?.email_address }}
          </p>
        </span>
      ...
      >
        ...
        <span class="col-span-2 float-left text-lg text-black-800">
          ...
          <p
            ...
            class="text-sm text-info cursor-pointer hover:underline"
          >
            {{ userProfileStore.user_profile?.contact_info?.phone_number }}
          </p>
        </span>
        <span class="col-span-4" />
        <n-tooltip placement="top" trigger="click">
