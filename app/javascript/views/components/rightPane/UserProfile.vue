<template>
  ...
  <div class="flex flex-col overflow-auto paneBody">
    <div class="flex items-center justify-center mt-2">
      <img
        :src="userProfileStore.user_profile?.image_url"
        alt="user avatar"
    ...
    <div class="flex flex-col mt-2">
      <span class="grid grid-cols-12 mx-4">
        <p class="col-span-11 font-bold text-xl break-words">
          {{ userProfileStore.user_profile?.username }}
        </p>
        <p
          v-if="ownProfile"
      ...
      <p
        v-if="userProfileStore.user_profile?.description"
        class="float-left text-md ml-4 break-words text-black-800 hover:underline cursor-pointer"
      >
        {{ userProfileStore.user_profile?.description }}
      </p>
      <p
        v-if="ownProfile && !userProfileStore.user_profile?.description"
        class="text-sm ml-4 text-info cursor-pointer hover:underline"
      >
        {{ $t('rightpane.add_description') }}
      </p>
      <p
        v-if="userProfileStore.user_profile?.pronounce_name"
        class="float-left text-md ml-4 break-words text-black-800 hover:underline cursor-pointer"
      >
        {{ userProfileStore.user_profile?.pronounce_name }}
      </p>
      <p
        v-if="ownProfile && !userProfileStore.user_profile?.pronounce_name"
        class="text-sm ml-4 text-info cursor-pointer hover:underline"
      >
      ...
      >
        <font-awesome-icon
          v-if="userProfileStore.user_profile?.isActive"
          icon="fa-circle"
        ...
        <p>
          {{
            userProfileStore.user_profile?.isActive
              ? $t('rightpane.active')
              : $t('rightpane.away')
          }}
        </p>
      ...
      >
        <p class="mr-3 text-lg">
          {{ userProfileStore.user_profile?.status.emoji }}
        </p>
        <p class="self-center">
          {{ userProfileStore.user_profile?.status.text }}
        </p>
      </span>
      <span class="flex float-left mx-4 text-md break-words text-black-800">
        ...
        <p class="float-left text-md break-words text-black-800">
          {{ userProfileStore.user_profile?.local_time }}
    ...
    >
      ...
      >
        ...
        <span class="col-span-2 -ml-4 float-left text-lg text-black-800">
          ...
          <p
            v-if="userProfileStore.user_profile?.contact_info?.email"
            id="email_address"
            class="text-sm text-info cursor-pointer hover:underline"
          >
            {{ userProfileStore.user_profile?.contact_info?.email }}
          </p>
          <p
            v-if="
              ownProfile && !userProfileStore.user_profile?.contact_info?.email
            "
            class="text-sm text-info cursor-pointer hover:underline"
          >
      ...
      >
        ...
        <span class="col-span-2 -ml-4 float-left text-lg text-black-800">
          ...
          <p
            v-if="userProfileStore.user_profile?.contact_info?.phone"
            id="phone_number"
            class="text-sm text-info cursor-pointer hover:underline"
          >
            {{ userProfileStore.user_profile?.contact_info?.phone }}
          </p>
          <p
            v-if="
              ownProfile && !userProfileStore.user_profile?.contact_info?.phone
            "
            class="text-sm text-info cursor-pointer hover:underline"
          >
    ...
    <span
      v-if="userProfileStore.user_profile?.about_me"
      class="flex flex-col float-left mx-4 mb-2 text-black-800"
    >
      <span class="grid grid-cols-12">
        <p class="col-span-11 font-bold text-md break-words">
      ...
      <span class="grid grid-cols-8 float-left mt-2 text-black-800">
        <span class="col-span-2 float-left text-md text-black-800">
          ...
          <p
            v-if="userProfileStore.user_profile?.about_me?.skype"
            class="text-sm text-info cursor-pointer hover:underline"
          >
            {{ userProfileStore.user_profile?.about_me?.skype }}
          </p>
          <p
            v-if="ownProfile && !userProfileStore.user_profile?.about_me?.skype"
            class="text-sm text-info cursor-pointer hover:underline"
          >
