  ...
  <div>
    ...
    <div class="border-b px-5 text-sm flex gap-12">
      <SearchCount :category="searches.messages" :heading="$t('search_bar.messages')"
        @click="changeEnabled($t('search_bar.messages'))" class="cursor-pointer py-2 px-5"
        :class="enabled.Messages ? 'border-b-2 border-primary font-semibold' : ''" />
      <SearchCount :category="searches.profiles" :heading="$t('search_bar.people')"
        @click="changeEnabled($t('search_bar.profiles'))" class="cursor-pointer py-2 px-5"
        :class="enabled.Profiles ? 'border-b-2 border-primary font-semibold' : ''" />
      <SearchCount :category="searches.channels" :heading="$t('search_bar.channels')"
        @click="changeEnabled($t('search_bar.channels'))" class="cursor-pointer py-2 px-5"
        :class="enabled.Channels ? 'border-b-2 border-primary font-semibold' : ''" />
    </div>
