<template>
  <div class="flex p-2 bg-slate-800 rounded-md border border-slate-300">
    <div @click="showMemberClickListener(true)" class="flex cursor-pointer">
      <img
        class="w-6 h-6 -ml-1 rounded-md border border-slate-300"
    ...
    <div class="rounded-md ml-2 border-2 border-slate-300"></div>
