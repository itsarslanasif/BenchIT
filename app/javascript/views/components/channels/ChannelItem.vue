<template>
  <n-dropdown class="rounded-md" placement="bottom-end" size="medium" :show="showChannelOptions"
    ...
    <div oncontextmenu="return false;" class="flex items-center pl-3 py-1 hover:bg-primaryHover cursor-pointer" @click="goTo(`/channels/${channel.id}`, this.channel, $event)"
