<template>
  <div
    ...
    <div v-click-outside="closeModal"
      class="rounded-md sm:w-flexible-lg md:w-flexible-lg lg:w-150 w-80 shadow-md bg-white" role="dialog">
      <div class="p-8">
        ...
        <div class="m-0 relative mt-5">
          ...
          <n-form :label-width="80" :model="formValue" :rules="rules">
            <n-form-item :label="$t('channels.new_channel_name')" path="channelName">
              <n-input v-model:value="formValue.channelName" :maxlength="80" :count-graphemes="countGraphemes" show-count
            ...
            <n-form-item class="mt-3" :label="$t('channels.new_channel_description')" path="Description">
              <n-input v-model:value="formValue.Description" :maxlength="500" :count-graphemes="countGraphemes" show-count
        ...
        <button type="button" class="focus:outline-none bg-none py-1 px-2 text-base float-right text-black-900 rounded"
          @click="closeModal">
