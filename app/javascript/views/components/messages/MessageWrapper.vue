  ...
  <div>
    <div class="items-center flex p-1 relative hover:bg-slate-100" @mouseover="emojiModalStatus = true"
      ...
      <div class="min-w-fit ml-1">
        <n-avatar v-show="!isSameUser" class="mr-1 self-baseline" size="large" :src="message.sender.avatar" />
      </div>
      <span class="message">
        <div class="ml-1">
          <span class="items-center flex text-black-800 text-lg m-0">
            ...
            <p class="text-xs"
              v-bind:class="{ time: !isSameUser, 'ml-2 mr-3 text-black-500 hover:underline cursor-pointer': isSameUser }">
